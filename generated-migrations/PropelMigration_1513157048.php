 ...
 * up to version 1513157048.
 * Generated on 2017-12-13 10:24:08 by eric
 */
class PropelMigration_1513157048
{
    public $comment = '';
...
ALTER TABLE `tweets`
  ...
  ADD `quality_tweet` TINYINT AFTER `location`,
...
ALTER TABLE `tweets`
  ...
  ADD `tweet_quality` enum(\'positive\',\'negative\',\'neutral\') AFTER `location`,
