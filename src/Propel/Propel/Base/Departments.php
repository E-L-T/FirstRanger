...
/**
 * Base class that represents a row from the 'departments' table.
 *
 *
 *
 * @package    propel.generator.Propel.Propel.Base
 */
abstract class Departments implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Propel\\Map\\DepartmentsTableMap';
    ...
    /**
     * Compares this with another <code>Departments</code> instance.  If
     * <code>obj</code> is an instance of <code>Departments</code>, delegates to
     * <code>equals(Departments)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Departments The current object, for fluid interface
     */
    ...
    public function setDepartmentId($v)
    {
        ...
        if ($this->department_id !== $v) {
            ...
            $this->modifiedColumns[DepartmentsTableMap::COL_DEPARTMENT_ID] = true;
        }
    ...
    public function setDepartmentName($v)
    {
        ...
        if ($this->department_name !== $v) {
            ...
            $this->modifiedColumns[DepartmentsTableMap::COL_DEPARTMENT_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DepartmentsTableMap::translateFieldName('DepartmentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->department_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DepartmentsTableMap::translateFieldName('DepartmentCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->department_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DepartmentsTableMap::translateFieldName('DepartmentName', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = DepartmentsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Propel\\Departments'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDepartmentsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Departments::setDeleted()
     * @see Departments::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDepartmentsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DepartmentsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DepartmentsTableMap::COL_DEPARTMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'department_id';
        }
        if ($this->isColumnModified(DepartmentsTableMap::COL_DEPARTMENT_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'department_code';
        }
        if ($this->isColumnModified(DepartmentsTableMap::COL_DEPARTMENT_NAME)) {
    ...
    {
        $pos = DepartmentsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Departments'][$this->hashCode()] = true;
        $keys = DepartmentsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getDepartmentId(),
            $keys[1] => $this->getDepartmentCode(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Propel\Departments
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setDepartmentCode($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setDepartmentName($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Propel\Departments The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DepartmentsTableMap::COL_DEPARTMENT_ID)) {
            $criteria->add(DepartmentsTableMap::COL_DEPARTMENT_ID, $this->department_id);
        }
        if ($this->isColumnModified(DepartmentsTableMap::COL_DEPARTMENT_CODE)) {
            $criteria->add(DepartmentsTableMap::COL_DEPARTMENT_CODE, $this->department_code);
        }
        if ($this->isColumnModified(DepartmentsTableMap::COL_DEPARTMENT_NAME)) {
            $criteria->add(DepartmentsTableMap::COL_DEPARTMENT_NAME, $this->department_name);
        }
    ...
    {
        $criteria = ChildDepartmentsQuery::create();
        $criteria->add(DepartmentsTableMap::COL_DEPARTMENT_ID, $this->department_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Propel\Departments (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Propel\Departments Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(DepartmentsTableMap::DEFAULT_STRING_FORMAT);
    }
