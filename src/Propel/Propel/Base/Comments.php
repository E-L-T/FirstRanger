...
abstract class Comments implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Propel\\Map\\CommentsTableMap';
     ...
     * @var        DateTime
     */
    protected $comment_publication_hour;

    /**
     * The value for the likes_count field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Propel\Propel\Base\Comments object.
     */
    ...
    /**
     * Get the [optionally formatted] temporal [comment_publication_hour] column value.
     *
     *
     ...
     */
    public function getCommentPublicationHour($format = NULL)
    {
        if ($format === null) {
            return $this->comment_publication_hour;
        } else {
            return $this->comment_publication_hour instanceof \DateTimeInterface ? $this->comment_publication_hour->format($format) : null;
        }
    }

    /**
     * Get the [likes_count] column value.
     *
     * @return int
     */
     ...
     * @return $this|\Propel\Propel\Comments The current object (for fluent API support)
     */
    public function setCommentPublicationHour($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->comment_publication_hour !== null || $dt !== null) {
            if ($this->comment_publication_hour === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->comment_publication_hour->format("Y-m-d H:i:s.u")) {
                $this->comment_publication_hour = $dt === null ? null : clone $dt;
                $this->modifiedColumns[CommentsTableMap::COL_COMMENT_PUBLICATION_HOUR] = true;
            }
        } // if either are not null

        return $this;
    } // setCommentPublicationHour()

    /**
     * Set the value of [likes_count] column.
     *
     * @param int $v new value
     * @return $this|\Propel\Propel\Comments The current object (for fluent API support)
     */
    public function setLikesCount($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->likes_count !== $v) {
            $this->likes_count = $v;
            $this->modifiedColumns[CommentsTableMap::COL_LIKES_COUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->comment_publication_hour = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CommentsTableMap::translateFieldName('LikesCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->likes_count = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Propel\\Comments'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentsTableMap::COL_LIKES_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'likes_count';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'comment_publication_hour':
                        ...
                        break;
                    case 'likes_count':
                        $stmt->bindValue($identifier, $this->likes_count, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Propel\Comments
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Propel\Comments The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentsTableMap::COL_LIKES_COUNT)) {
            $criteria->add(CommentsTableMap::COL_LIKES_COUNT, $this->likes_count);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Propel\Comments (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Propel\Comments Clone of current object.
     * @throws PropelException
     */
