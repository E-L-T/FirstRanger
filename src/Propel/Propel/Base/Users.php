...
abstract class Users implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Propel\\Map\\UsersTableMap';
    ...
    public function setTwitterAccount($v)
    {
        ...
        if ($this->twitter_account !== $v) {
            ...
            $this->modifiedColumns[UsersTableMap::COL_TWITTER_ACCOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('TwitterAccount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Propel\\Users'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->commentssScheduledForDeletion !== null) {
                if (!$this->commentssScheduledForDeletion->isEmpty()) {
                    \Propel\Propel\CommentsQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_TWITTER_ACCOUNT)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Propel\Users
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setTwitterAccount($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Propel\Users The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_TWITTER_ACCOUNT)) {
            $criteria->add(UsersTableMap::COL_TWITTER_ACCOUNT, $this->twitter_account);
        }
        if ($this->isColumnModified(UsersTableMap::COL_PASSWORD)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Propel\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Propel\Users Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCommentss($overrideExisting = true)
    {
        ...
        $this->collCommentss->setModel('\Propel\Propel\Comments');
    }
