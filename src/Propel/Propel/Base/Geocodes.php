...
/**
 * Base class that represents a row from the 'geocodes' table.
 *
 *
 *
 * @package    propel.generator.Propel.Propel.Base
 */
abstract class Geocodes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Propel\\Map\\GeocodesTableMap';
    ...
    /**
     * The value for the geocode_name field.
     *
     * @var        string
     */
    protected $geocode_name;
    ...
    /**
     * Compares this with another <code>Geocodes</code> instance.  If
     * <code>obj</code> is an instance of <code>Geocodes</code>, delegates to
     * <code>equals(Geocodes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Geocodes The current object, for fluid interface
     */
    ...
    /**
     * Get the [geocode_name] column value.
     *
     * @return string
     */
    public function getGeocodeName()
    {
        return $this->geocode_name;
    }
    ...
    public function setGeocodeId($v)
    {
        ...
        if ($this->geocode_id !== $v) {
            $this->geocode_id = $v;
            $this->modifiedColumns[GeocodesTableMap::COL_GEOCODE_ID] = true;
        }
    ...
    /**
     * Set the value of [geocode_name] column.
     *
     * @param string $v new value
     * @return $this|\Propel\Propel\Geocodes The current object (for fluent API support)
     */
    public function setGeocodeName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->geocode_name !== $v) {
            $this->geocode_name = $v;
            $this->modifiedColumns[GeocodesTableMap::COL_GEOCODE_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GeocodesTableMap::translateFieldName('GeocodeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->geocode_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GeocodesTableMap::translateFieldName('GeocodeName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->geocode_name = (null !== $col) ? (string) $col : null;
            ...
            return $startcol + 4; // 4 = GeocodesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGeocodesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Geocodes::setDeleted()
     * @see Geocodes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGeocodesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GeocodesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GeocodesTableMap::COL_GEOCODE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'geocode_id';
        }
        if ($this->isColumnModified(GeocodesTableMap::COL_GEOCODE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'geocode_name';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'geocode_id':
                        ...
                        break;
                    case 'geocode_name':
                        $stmt->bindValue($identifier, $this->geocode_name, PDO::PARAM_STR);
                        break;
                    case 'department_id':
    ...
    {
        $pos = GeocodesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Geocodes'][$this->hashCode()] = true;
        $keys = GeocodesTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Propel\Geocodes
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setGeocodeId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setGeocodeName($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Propel\Geocodes The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GeocodesTableMap::COL_GEOCODE_ID)) {
            $criteria->add(GeocodesTableMap::COL_GEOCODE_ID, $this->geocode_id);
        }
        if ($this->isColumnModified(GeocodesTableMap::COL_GEOCODE_NAME)) {
            $criteria->add(GeocodesTableMap::COL_GEOCODE_NAME, $this->geocode_name);
        }
        if ($this->isColumnModified(GeocodesTableMap::COL_DEPARTMENT_ID)) {
    ...
    {
        $criteria = ChildGeocodesQuery::create();
        $criteria->add(GeocodesTableMap::COL_GEOCODE_ID, $this->geocode_id);
    ...
    {
        $validPk = null !== $this->getGeocodeId();
    ...
    /**
     * Generic method to set the primary key (geocode_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Propel\Geocodes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Propel\Geocodes Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(GeocodesTableMap::DEFAULT_STRING_FORMAT);
    }
