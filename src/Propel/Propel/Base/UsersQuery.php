 ...
 * @method     ChildUsersQuery orderByTwitterAccount($order = Criteria::ASC) Order by the twitter_account column
 ...
 * @method     ChildUsersQuery groupByTwitterAccount() Group by the twitter_account column
 ...
 *
 * @method     \Propel\Propel\CommentsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUsers findOneByTwitterAccount(string $twitter_account) Return the first ChildUsers filtered by the twitter_account column
 ...
 * @method     ChildUsers requireOneByTwitterAccount(string $twitter_account) Return the first ChildUsers filtered by the twitter_account column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUsers[]|ObjectCollection findByTwitterAccount(string $twitter_account) Return ChildUsers objects filtered by the twitter_account column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT user_id, firstname, lastname, email, twitter_account, password FROM users WHERE user_id = :p0';
        try {
    ...
    public function filterByTwitterAccount($twitterAccount = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersTableMap::COL_TWITTER_ACCOUNT, $twitterAccount, $comparison);
    }
    ...
    /**
     * Filter the query by a related \Propel\Propel\Comments object
     *
     * @param \Propel\Propel\Comments|ObjectCollection $comments the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByComments($comments, $comparison = null)
    {
        if ($comments instanceof \Propel\Propel\Comments) {
            ...
            throw new PropelException('filterByComments() only accepts arguments of type \Propel\Propel\Comments or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Propel\Propel\CommentsQuery A secondary query class using the current class as primary query
     */
    public function useCommentsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinComments($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Comments', '\Propel\Propel\CommentsQuery');
    }
