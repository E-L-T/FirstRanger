...
use Propel\Propel\Comments;
use Propel\Propel\CommentsQuery;
...
class CommentsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.CommentsTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\Comments';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.Comments';
     ...
     */
    const COL_COMMENT_PUBLICATION_HOUR = 'comments.comment_publication_hour';

    /**
     * the column name for the likes_count field
     */
    const COL_LIKES_COUNT = 'comments.likes_count';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\Comments');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\Comments) { // it's a model object
