...
use Propel\Propel\DistrictShares;
use Propel\Propel\DistrictSharesQuery;
...
class DistrictSharesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.DistrictSharesTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\DistrictShares';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.DistrictShares';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\DistrictShares');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\DistrictShares) { // it's a model object
